...
export const Navigation = () => {
  ...
  function loadGoogleButton(e){
    ...
    return(
      ...
      <nav>
          <ul>
            <li ><NavLink id="homeLink" exact to="/" onClick={addActiveHome}>Home</NavLink></li>
            <li ><NavLink  to="/about" onClick={removeActiveHome}>About</NavLink></li>
            <li ><NavLink  to="/contact" onClick={removeActiveHome}>Contact</NavLink></li>
            <li ><NavLink  to="/login" onClick={loadGoogleButton}>Login</NavLink></li>
          </ul>
      </nav> 
    ) 
