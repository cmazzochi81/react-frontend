...
export const HomePage = () => {
  ...
  return (
    <div class="content-container w-full md:w-7/12  ">
...
export const AboutPage = () => {
  ...
  return (
    <div class="content-container w-full md:w-7/12 bg-black">
      <img
        width="200"
        height="200"
        src={logo}
      ...
      <div className="H1andMainTextDiv p-5 bg-white">
        <h1 class="heading font-Le-Havre text-4xl">{data.name}</h1>
        <div class="imageDiv flex justify-between max-h-80  ">
          <img
            id="aboutImg"
            width="300"
            src={data.avatar_url}
  ...
  return (
    <>
      <Form>
        ...
        <button
          className="focus:ring-8 font-Raleway text-white"
...
export const LogInPage = () => {
  ...
  return (
    <div className="content-container bg-black p-10 w-full md:w-7/12">
      <div id="login-container " className="bg-white p-1 w-4/5">
        ...
        <input
          class="login-input focus:ring-8 text-center font-Raleway"
          value={emailValue}
          type="text"
        ...
        <button
          class="font-Raleway focus:ring-8"
        ...
        <button
          class="back-home-button font-Raleway focus:ring-8"
          onClick={() => history.push("/")}
        >
          Home
        </button>
  ...
  return (
    <div className="content-container w-full md:w-7/12">
      ...
      >
        ...
        <h1 class="heading font-Le-Havre text-3xl">Sign Up</h1>

        {errorMessage && <div className="fail">{errorMessage}</div>}
        <input
          class="font-Raleway text-center"
          value={emailValue}
          type="text"
          //binding state to input
          onChange={(e) => setEmailValue(e.target.value)}
        ...
        <button
          class="font-Raleway signup-button"
          disabled={
            !emailValue ||
            !passwordValue ||
        ...
        <button
          class="font-Raleway back-home-button text-white focus:ring-8"
          onClick={() => history.push("/")}
        >
          Back Home
        </button>
...
export const ForgotPasswordPage = () => {
  ...
  return success ? (
    <>
      <h1 class="heading my-5 font-Le-Havre text-3xl">Sent!</h1>
      <p class="font-Raleway">Please check your email for a reset link</p>
    </>
  ) : (
    <>
